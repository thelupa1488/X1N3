...
namespace EnginePrediction
{
	...
	void Begin(CUserCmd* pCmd)
	{
		...
		{
			_prediction_seed = *(int32_t**)(CSX::Memory::FindPatternV2(XorStr("client.dll"), XorStr("8B 0D ? ? ? ? BA ? ? ? ? E8 ? ? ? ? 83 C4 04")) + 2);
			_prediction_player = (CBaseEntity***)(CSX::Memory::FindPatternV2(XorStr("client.dll"), XorStr("89 35 ? ? ? ? F3 0F 10 48 20")) + 2);
		}
